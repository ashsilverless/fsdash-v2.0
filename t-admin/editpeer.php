...
$conn = new PDO("mysql:host=$host;dbname=$db", $user, $pass);
	...
	$sql = "UPDATE `tbl_fs_peers` SET `fs_peer_name`='$fs_peer_name', `fs_peer_return`='$fs_peer_return', `fs_peer_volatility`='$fs_peer_volatility', `fs_peer_color`='$fs_peer_color', `confirmed_by`='$name', `confirmed_date`='$str_date', `fs_trend_line`='$fs_trend_line' WHERE (`id`='$id')";
