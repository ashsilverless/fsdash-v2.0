...
<form action="addacount.php" method="post" id="addacount" name="addacount" class="asset-form">
    <div class="content new-account">
            <!--add accounts-->
            <div class="add-account">
                <h3 class="heading heading__4">New Account Details</h3>
                <div class="add-account__new">

                    <div class="item">
                        <label>Client Code</label>
                        <input type="text" id="ac_client_code" name="ac_client_code" value="">
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <input type="text" id="ac_designation" name="ac_designation" value="">
                    </div>

                    <div class="item last">
                        <label>Display Name</label>
                        <input type="text" id="ac_display_name" name="ac_display_name" value="">
                    </div>
                </div>
            </div><!--add account-->
    </div><!--content-->
